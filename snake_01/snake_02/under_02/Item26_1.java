...
public class Item26_1 implements Interface
{
  private String id;
  private String name;
  private double price;
  private double tax;
  private Calc26_1 calc;


  public Item26_1 id( String id ){
    this.id = id;
    return this;
  }

  public Item26_1 name( String name ){
    this.name = name;
    return this;
  }

  public Item26_1 price( double price ){
    this.price = price;
    return this;
  }

  public Item26_1 tax( double tax ){
    this.tax = tax;
    return this;
  }

  public Item26_1 calc( Calc26_1 calc ){
    this.calc = calc;
    return this;
  }

  public static void save( Consumer<Item26_1> con ){
    Item26_1 item = new Item26_1();
    con.accept( item );
    indi( "save :" + item );
  }
  ...
  public String toString(){
    return( "Item26_1 :" + "id=" + id + " " + "name=" + name + " " + "price=" + price + " " + "tax=" + tax );
  }
